...
| Settings layout | `light-en-settings.png` shows consistent section spacing, aligned labels/controls, and no clipping in the fixed 760 × 640 content area. | [x] | [ ] | English Settings capture inspected at the fixed rectangular size. |
