...
| Settings layout | `light-en-settings.png` shows consistent section spacing, aligned labels/controls, and no clipping at the target size. | [x] | [ ] | English Settings capture inspected at 640 × 732. |
